...
<h3> Bienvenue dans la page de recherche </h3>

<section id="searchbox">
	<form id="search_form" method="get" action="<?php echo PATH;?>search/index">
...
<?php else :?>	
<?php foreach($this->search_result as $found_user) 
{
	echo $found_user->full_name() . "  ". $found_user->profession." ".$found_user->ville."</br>";
	$telephones = Telephone::find_by_user_id($found_user->id);
	if(!empty($telephones)){
